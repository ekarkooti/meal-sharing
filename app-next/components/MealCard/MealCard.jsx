...
export const Meal = ({ meal }) => {
  const { id, title, description, price, photo_address, servings, cuisine } =
    meal;
  const defaultImageSrc =
    "https://placehold.co/400x250/E0E0E0/333333?text=No+Image";
  ...
  return (
    <Link href={`/meals/${id}`} className="meal-card-link">
      <div className="meal-card">
        {photo_address && (
          <Image
            src={photo_address || defaultImageSrc}
